...
class Cart(models.Model):
    ...
    subtotal = models.DecimalField(default=Decimal(0.00), max_digits=50, decimal_places=2)
    total = models.DecimalField(default=Decimal(0.00), max_digits=50, decimal_places=2)
...
def pre_save_cart_receiver(sender, instance, *arags, **kwargs):
    total = instance.subtotal + Decimal(value=10.00)
